      ...
      <div className="container mx-auto">
        <div className="mb-8 text-center">
          <h2 className={`text-4xl font-bold ${darkMode ? 'text-gray-200' : 'text-gray-800'}`}>
            Portafolio de Sandyslein Correa Bueno
          </h2>
          <p className={`text-lg ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            Explora mis habilidades, experiencia y proyectos destacados.
          </p>
        </div>
        ...
        <div className={`p-6 rounded-xl shadow-lg  ${darkMode ? 'bg-gray-800 text-gray-200' : 'bg-white text-gray-800'}`}>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-6 space-y-2">
              <li>Actualmente trabaja en proyectos de software utilizando tecnologías como:</li>
              <ul className="list-inside ml-6">
                <li>FastAPI, Docker, PostgreSQL, Java con Spring, y Kotlin para Android.</li>
              </ul>
              <li>Desarrollo de APIs e implementación de arquitecturas como:</li>
              <ul className="list-inside ml-6">
                <li>Clean, Hexagonal, y por Capas.</li>
              </ul>
              <li>Pruebas con herramientas como <code>pytest</code> y <code>httpx</code>.</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gradient-to-br from-blue-500 to-purple-500 text-white p-4 rounded-lg shadow-lg">
              ...
              <p>FastAPI, Docker, PostgreSQL, Java Spring, Kotlin</p>
            </div>
